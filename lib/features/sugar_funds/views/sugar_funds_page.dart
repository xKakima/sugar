...
import 'package:sugar/core/database/expense.dart';
...
class SugarFundsPage extends StatefulWidget {
  ...
  @override
  State<SugarFundsPage> createState() => SugarFundsPageState();
}

class SugarFundsPageState extends State<SugarFundsPage>
  ...
  void initState() {
    ...
    // Initialize stream based on partner ID
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.controller.expenseType.value == type
    ...
    return Column(
      ...
      children: [
        ...
        Numpad(
          ...
          onSubmit: () async {
            final response = await widget.controller.createExpense();
            if (response['success']) {
              widget.controller.toggleExpanded();
            }
          },
