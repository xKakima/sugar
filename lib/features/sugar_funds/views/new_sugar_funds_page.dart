...
class NewSugarFundsPage extends GetView<SugarFundsPageController> {
  final String title;
    ...
    return Scaffold(
      ...
      body: BasePageLayout(
        child: StreamBuilder<List<Map<String, dynamic>>>(
          stream: controller.expenseStream,
  ...
  Widget _buildAnimatedContainer(BuildContext context, List<ExpenseData> expenses) {
    return Obx(
      () => Positioned(
        bottom: 0,
        left: 0,
