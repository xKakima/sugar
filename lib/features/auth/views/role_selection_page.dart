...
import 'package:sugar/shared/widgets/buttons/rectangle_button.dart';
import 'package:sugar/core/services/data_store_controller.dart';
import 'package:sugar/core/database/user_data.dart';
import 'package:sugar/features/auth/views/invite_page.dart';

class RoleSelectionPage extends StatefulWidget {
  const RoleSelectionPage({super.key});

  @override
  State<RoleSelectionPage> createState() => RoleSelectionPageState();
}
...
class RoleSelectionPageState extends State<RoleSelectionPage> {
  ...
  Future<void> _onRoleSelected(String role) async {
    await upsertUserData({"user_type": role});
