...
import 'package:sugar/features/auth/views/role_selection_page.dart';
...
class PartnerCodePage extends StatefulWidget {
  ...
  @override
  State<PartnerCodePage> createState() => PartnerCodePageState();
}

class PartnerCodePageState extends State<PartnerCodePage> {
  ...
  void initState() {
    ...
    _partnerCodeController.addListener(() {
      ...
      if (currentText.length > _previousText.length + 3) {
        // Text was pasted, no action needed
