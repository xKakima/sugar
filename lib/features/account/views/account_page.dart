...
import 'package:sugar/features/account/controllers/account_page_controller.dart';
import 'package:sugar/core/database/account.dart';
import 'package:sugar/shared/utils/constants.dart';
import 'package:sugar/shared/widgets/account_box.dart';
import 'package:sugar/features/account/views/account_page_header.dart';
  ...
  Future<List<AccountBox>?> loadAccounts() async {
    try {
      ...
      if (response == null || response.isEmpty) {
        // No accounts found, return empty box
      ...
      body: FutureBuilder<List<AccountBox>?>(
        ...
        builder: (context, snapshot) {
          ...
          return Obx(() => Stack(
                children: [
                  Container(
                    color: !widget.controller.isExpanded.value
        ...
        Align(
          ...
          child: IconButton(
              ...
              onPressed: () async {
                ...
                // Account update response received
                if (response['success']) {
                  setState(() {
    ...
    return Column(
      ...
      children: [
        ...
        Numpad(
          ...
          onSubmit: () => widget.controller.updateAccount(),
        ...
        Align(
          ...
          child: PlusButton(
            onPressed: () => {
              // Update editing state to edit account mode
