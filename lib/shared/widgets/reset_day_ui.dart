...
class ResetDayUI extends StatefulWidget {
  ...
  @override
  State<ResetDayUI> createState() => ResetDayUIState();
}

class ResetDayUIState extends State<ResetDayUI> {
      ...
      children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 171, 171, 171)
                            .withAlpha(51), // 0.2 opacity = 51/255 // Black color with 20% opacity
        ...
        Align(
          ...
          child: IconButton(
            ...
            onPressed: () {
              // Save selected reset day and confirm
